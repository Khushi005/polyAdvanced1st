// This script batch mints mylili ERC721A tokens.
...
async function main() {
  ...
  const contractAddress = "0xa0B68e4A2d91FEee686663B4ad2c7b2dBe0f42B7";

  // Get the contract factory and attach it to the signer
  const IndianNFT = await ethers.getContractFactory("mylili", signer);
