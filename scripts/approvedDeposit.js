...
const ABI = require("../artifacts/contracts/mylili.sol/mylili.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("mylili");
  const nft = await NFT.attach("0xa0B68e4A2d91FEee686663B4ad2c7b2dBe0f42B7");
